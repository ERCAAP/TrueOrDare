      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity 
            style={[
              styles.playButton,
              players.length < 2 && styles.playButtonDisabled
            ]} 
            onPress={handlePlayPress}
          >
            <ThemedText style={styles.playButtonText}>HEMEN OYNA</ThemedText>
          </TouchableOpacity>
          ...
          <TouchableOpacity 
            ...
            onPress={handlePlayPress}
          >
            <ThemedText style={styles.smallPlayButtonText}>SONRA OYNA</ThemedText>
          </TouchableOpacity>
        </View>
      </View>
